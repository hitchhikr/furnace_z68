...
class FurnaceGUI {
  ...
  bool displayNew, displayExport, displayExportFirst, displayPalette, fullScreen, sysFullScreen, preserveChanPos, sysDupCloneChannels, sysDupEnd;
