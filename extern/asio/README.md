...
this is `ASIO-SDK_2.3.4_2025-10-15.zip`, the latest version and the first open-source release.

it has been adapted to use the CMake build system and improve compatibility with MinGW. no modifications to the original source have been made.

this distribution is licensed under the GNU General Public License (GPL) version 3, as permitted by the dual licensing model explained in LICENSE.txt.
